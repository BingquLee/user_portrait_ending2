    ...
    if result:
        ...
        for item in result:
            ...
            if not user_dict['uid'] in filter_set:
                ...
                user_result.append([user_dict['uid'], user_dict['uname'], user_dict['location'], user_dict['activeness'], user_dict['importance'], user_dict['influence'], score, user_dict['sensitive']])
