...
function bind_button_click(){
    ...
    $('#seed_user #bi_way .inline-checkbox').click(function(){
        if($(this).is(':checked')){
            $('#seed_user input[name="hop_choose"]').attr('disabled',false);
            //$('#seed_user #events_to').attr('disabled',false);
        }
        else{
            //$('#seed_user #events_from').attr('disabled', true);
            $('#seed_user input[name="hop_choose"]').attr('disabled',true);
...
function seed_single_user_data(){
    ...
    if($('#advanced_condition').attr('display') == 'none'){
        ...
        console.log($('#seed_user input[name="hop_choose"]').attr("disabled"))
        if($('#seed_user input[name="hop_choose"]').attr("disabled") == undefined){
            url += '&hop=' + $('#seed_user [name="hop_choose"]:checked').val();
        }
        $('#seed_user #bi_way .inline-checkbox').each(function(){
            if($(this).is(':checked')){
                url += '&' + $(this).next().attr('id') + '=1';
            }
        });
