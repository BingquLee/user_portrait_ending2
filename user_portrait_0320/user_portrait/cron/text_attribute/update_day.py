...
from global_utils import es_user_portrait, portrait_index_name, portrait_index_type, es_bci_history, bci_history_index_name, bci_history_index_type
...
if __name__=='__main__':
    ...
    #uid_list = ['1765335300', '1005413812']
    #results = update_day_profile(uid_list)
    #print 'results:', results
